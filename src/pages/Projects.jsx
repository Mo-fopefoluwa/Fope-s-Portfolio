          ...
          {/* <motion.div variants={fadeIn("up", "tween", 0.4, 1.5)}>
            <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                <p className="mb-1 text-lg font-bold text-red-600">Yes App</p>
                <p className="mb-4 text-xs text-gray-100">
                  {" "}
                  JSX, React JS and Tailwind CSS
                </p>
                <p className="mb-4 text-xs tracking-wide text-gray-400">
                  This is a fully functional and responsive sign up and sign in
                  page . It was built with react js, firebase and styled with
                  Tailwind css.
                </p>
          ...
          {/* <motion.div variants={fadeIn("up", "tween", 0.8, 1.5)}>
            <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                ...
                <p className="mb-4 text-xs tracking-wide text-gray-400">
                  A simple e-commerce store built with Jsx, Tailwind CSS, React
                  JS and FreeStoreAPI
                </p>
                <div className="text-white flex items-center justify-center space-x-3">
                  <a
